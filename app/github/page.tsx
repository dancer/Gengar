      ...
      if (avatarRef.current) {
        await new Promise(resolve => {
          if (avatarRef.current?.complete) resolve(null)
            ...
            avatarRef.current?.addEventListener('load', () => resolve(null), {
              once: true,
            })
        })
      }
    ...
    <div className="space-y-8 font-mono">
      ...
      {userData && (
        <div className="space-y-4">
          <Card
            ref={cardRef}
            className="relative overflow-hidden bg-background border-border shadow-[0_0_50px_rgba(0,255,0,0.05)]"
          >
                ...
                <div className="flex-1 pt-1">
                  ...
                  <div className="space-y-1 mt-1">
                    ...
                    <p className="text-xs text-muted-foreground/60">
                      #{String(userData.id).padStart(3, '0')}
                    </p>
                  </div>
                  {userData.bio && (
            ...
            <div className="p-6 grid grid-cols-2 gap-6">
              ...
              <StatBar
                ...
                maxValue={1000}
              />
              <StatBar label="Stars" value={userData.stars} maxValue={1000} />
              <StatBar
