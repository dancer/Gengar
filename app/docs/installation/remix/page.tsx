  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Follow these steps to install and set up Gengar UI with Remix and
        Tailwind CSS v4.
      </p>
  ...
  plugins: {
    "@tailwindcss/postcss": {},
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Create or update your app/styles/global.css file with Tailwind v4
...
export function links() {
  return [{ rel: "stylesheet", href: styles }]
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          You can now start using Gengar UI components in your Remix project.
        ...
        <div className="mt-4 p-4 bg-muted rounded-lg">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>
              • <strong>Remix-optimized</strong> - Works seamlessly with Remix's
              routing and data loading
            </li>
            <li>
              • <strong>Server-side rendering</strong> - Full SSR support with
              proper CSS delivery
            </li>
            <li>
