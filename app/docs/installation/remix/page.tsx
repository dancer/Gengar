...
module.exports = {
  ...
  plugins: [require("tailwindcss-animate")],
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Create or update your app/styles/global.css file:
        </p>
        <Card className="overflow-hidden border-border bg-background">
          <div className="flex items-center gap-2 border-b border-border px-4 py-2">
            <div className="h-3 w-3 rounded-full bg-red-500" />
            <div className="h-3 w-3 rounded-full bg-yellow-500" />
            <div className="h-3 w-3 rounded-full bg-green-500" />
            <span className="ml-2 text-sm text-muted-foreground">app/styles/global.css</span>
          </div>
          <pre className="p-4">
            <code className="text-sm text-foreground">
              {`@tailwind base;
  ...
  * {
  ...
  body {
    @apply bg-background text-foreground;
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-foreground">5. Import styles in root</h2>
        <p className="text-muted-foreground">
        ...
        <Card className="overflow-hidden border-border bg-background">
          <div className="flex items-center gap-2 border-b border-border px-4 py-2">
            ...
            <div className="h-3 w-3 rounded-full bg-yellow-500" />
            <div className="h-3 w-3 rounded-full bg-green-500" />
            <span className="ml-2 text-sm text-muted-foreground">app/root.tsx</span>
          </div>
          <pre className="p-4">
            <code className="text-sm text-foreground">
