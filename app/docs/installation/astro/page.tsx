  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Follow these steps to install and set up Gengar UI with Astro and
        Tailwind CSS v4.
      </p>
      ...
      <div className="space-y-4">
        ...
        <Card className="overflow-hidden border-border bg-background">
          ...
          <pre className="p-4">
            <code className="text-sm text-foreground">
              npm install tailwindcss @tailwindcss/astro @radix-ui/react-slot
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Update your astro.config.mjs file to include the Tailwind CSS v4
          integration:
        </p>
        <Card className="overflow-hidden border-border bg-background">
          <div className="flex items-center gap-2 border-b border-border px-4 py-2">
...
export default defineConfig({
  integrations: [tailwind()]
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Create or update your src/styles/global.css file with Tailwind v4
  ...
  body {
    ...
    color: hsl(var(--color-foreground));
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          You can now start using Gengar UI components in your Astro project.
        ...
        <div className="mt-4 p-4 bg-muted rounded-lg">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>
              • <strong>Native Astro integration</strong> - First-party support
              for Tailwind v4
            </li>
            <li>
              • <strong>Island architecture</strong> - Optimized for Astro's
              component hydration
            </li>
            <li>
