  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Follow these steps to install and set up Gengar UI with Vite and
        Tailwind CSS v4.
      </p>
      ...
      <div className="space-y-4">
        ...
        <Card className="overflow-hidden border-border bg-background">
          ...
          <pre className="p-4">
            <code className="text-sm text-foreground">
              npm install tailwindcss @tailwindcss/vite @radix-ui/react-slot
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Update your vite.config.ts file to use the Tailwind CSS v4 Vite
          plugin:
        </p>
        <Card className="overflow-hidden border-border bg-background">
          <div className="flex items-center gap-2 border-b border-border px-4 py-2">
  ...
  plugins: [
    ...
    tailwindcss()
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Update your index.css file with Tailwind v4 imports and theme
          configuration:
        </p>
        <Card className="overflow-hidden border-border bg-background">
          <div className="flex items-center gap-2 border-b border-border px-4 py-2">
  ...
  body {
    ...
    color: hsl(var(--color-foreground));
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          You can now start using Gengar UI components in your Vite project.
        ...
        <div className="mt-4 p-4 bg-muted rounded-lg">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>
              • <strong>Optimized for Vite</strong> - First-party Vite plugin
              for maximum performance
            </li>
            <li>
              • <strong>Hot Module Replacement</strong> - Instant style updates
              during development
            </li>
            <li>
