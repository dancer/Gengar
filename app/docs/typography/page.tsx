  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Gengar UI uses a carefully crafted typography system to create a
        consistent and readable interface. Here's an overview of the typography
        styles available.
      </p>
      ...
      <div className="space-y-4">
        ...
        <Card className="overflow-hidden border-border bg-background p-6">
          <p className="text-base mb-4 text-foreground">
            This is a standard paragraph. It uses the base font size and line
            height.
          </p>
          <p className="text-sm mb-4 text-muted-foreground">
            This is a smaller paragraph, useful for less important information
            or UI elements.
          </p>
          <p className="text-lg text-foreground">
            This is a larger paragraph, which can be used for introductory text
            or to add emphasis.
          </p>
        </Card>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Card className="overflow-hidden border-border bg-background p-6">
          ...
          <p className="mb-2 text-foreground">
            <em>Italic text</em> for slight emphasis
          </p>
          <p className="mb-2 text-foreground">
