        ...
        <Tabs defaultValue="preview" className="space-y-4">
          ...
          {preview && (
            <TabsContent value="preview" className="space-y-4">
              <Card className="bg-background border-border p-6">{preview}</Card>
            </TabsContent>
          )}
          {code && (
        ...
        <div className="space-y-4">
          ...
          <Card>
            <TerminalWindow title="terminal">
              <pre className="p-4">
                <code className="text-sm text-foreground">{installation}</code>
              </pre>
            </TerminalWindow>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <TerminalWindow title="example.tsx">
              <pre className="p-4">
                <code className="text-sm text-foreground">{usage}</code>
              </pre>
            </TerminalWindow>
          </Card>
        </div>
